  ...
  return (
    <main className={`app-shell ${dragged ? "is-dragging" : ""}`} style={appStyle}>
      ...
      <section className="map-panel">
        ...
        <div className="map-provider-note"><strong>{valueMapsEnabled ? "Mapbox · Faded" : "Mapbox 연결 대기"}</strong><span>{valueMapsEnabled ? `${process.env.NEXT_PUBLIC_ROUTE_API_URL?.trim() ? "OSRM" : "Mapbox"} 자동차 경로 · Google Places 장소 검색` : "공개 토큰을 연결하면 지도가 표시됩니다"}</span></div>
